    ...
    <>
      ...
      <div className={`fixed lg:static top-0 right-0 z-50 w-64 h-full bg-white shadow-lg border-gray-50 border-[1px] rounded-l-2xl p-6 transform transition-transform duration-300 ease-in-out ${
        ...
        <ul className="mt-6 space-y-2 overflow-y-auto h-[60vh] lg:h-fit scrollbar-hide">
          ...
          <li onClick={() => handleNavigation('/admin/dashboard/users')} 
              className={`flex items-center space-x-2 text-[#020A47] hover:bg-gray-100 p-2 rounded-lg cursor-pointer ${location.pathname === '/admin/dashboard/users' ? col : ''}`}>
            <FaUser className="text-lg" />
            <span>Users</span>
          </li>

          <li onClick={() => handleNavigation('/admin/dashboard/analytics')} 
              className={`flex items-center space-x-2 text-[#020A47] hover:bg-gray-100 p-2 rounded-lg cursor-pointer ${location.pathname === '/admin/dashboard/analytics' ? col : ''}`}>
          ...
          <li onClick={() => handleNavigation('/admin/dashboard/award-points')} 
              className={`flex items-center space-x-2 p-2 rounded-lg hover:bg-gray-100 cursor-pointer ${location.pathname === '/admin/dashboard/award-points' ? col : ''}`}>
            <LiaAwardSolid className="text-xl font-semibold" />
            <span>Award Points</span>
          </li>

          <li onClick={() => handleNavigation('/admin/dashboard/purchase-history')} 
              className={`flex items-center space-x-2 p-2 rounded-lg hover:bg-gray-100 cursor-pointer ${location.pathname === '/admin/dashboard/purchase-history' ? col : ''}`}>
            <HiMiniDocumentCurrencyRupee className="text-xl font-semibold" />
            <span>Purchase History</span>
          </li>

          <li onClick={() => handleNavigation('/admin/dashboard/affiliate')} 
              className={`flex items-center space-x-2 p-2 rounded-lg hover:bg-gray-100 cursor-pointer ${location.pathname === '/admin/dashboard/affiliate' ? col : ''}`}>
            <FaHistory />
            <span>Affiliate</span>
          </li>

          <li onClick={() => handleNavigation('/admin/dashboard/setting')} 
              className={`flex items-center space-x-2 p-2 rounded-lg hover:bg-gray-100 cursor-pointer ${location.pathname === '/admin/dashboard/setting' ? col : ''}`}>
            <IoSettingsSharp />
            <span>Setting</span>
          </li>

          <li onClick={() => handleNavigation('/admin/dashboard/support')} 
              className={`flex items-center space-x-2 p-2 rounded-lg hover:bg-gray-100 cursor-pointer ${location.pathname === '/admin/dashboard/support' ? col : ''}`}>
            <FaCommentDots />
            <span>Support</span>
          </li>
